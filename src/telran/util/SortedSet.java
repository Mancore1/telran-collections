...
public interface SortedSet<T> extends Set<T> {
	...
	// Returns a shallow copy of the portion of this set whose elements are less
	// than (or equal to, if inclusive is true) toElement.
	SortedSet<T> headSetCopy(T toElement, boolean inclusive);

	// Returns a shallow copy of the portion of this set whose elements are greater
	// than (or equal to, if inclusive is true) fromElement.
	SortedSet<T> tailSetCopy(T fromElement, boolean inclusive);

	// Returns a shallow copy of the portion of this set whose elements range from
